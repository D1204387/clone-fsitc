  ...
  return function(t) {
    ...
    26: function(t, e, r) {
      ...
      function l() {
        ...
        return r && (Array.isArray(r.$sub) || (r.$sub = []),
            r.$sub.push(t)),
            t
      }
      function s(t) {
        ...
        value: !0
          ...
          e.patchChildren = function(t, e) {
            o(t) && o(e) ? t !== e && function(t, e) {
              ...
              for (; h <= v && y <= b; )
                n(p) ? p = t[++h] : n(m) ? m = t[--v] : i(p, g) ? (c(p, g),
                    p = t[++h],
                    g = e[++y]) : i(m, M) ? (c(m, M),
                    m = t[--v],
                    M = e[--b]) : i(p, M) ? (c(p, M),
                    ...
                    m = t[--v],
                    g = e[++y]) : (n(r) && (r = a(t, h, v)),
                    n(f = o(g.key) ? r[g.key] : null) ? (u(g),
                        g = e[++y]) : i(d = t[f], g) ? (c(d, g),
                        t[f] = void 0,
                        g = e[++y]) : (u(g),
                        g = e[++y]));
    ...
    28: function(t, e, r) {
        ...
        var e = t.extend({
          ...
          methods: {
            runRule: function(e) {
              ...
              (0,
                  o.pushParams)();
              var n, i = this.rule.call(this.rootModel, r, e), u = d(n = i) && f(n.then) ? function(t, e) {
                var r = new t({
                  data: {
                    p: !0,
                    v: !1
          ...
          computed: {
            ...
            children: function() {
              ...
              return this.keys.map(function(e) {
                var u = t.tracker(e);
                return i.hasOwnProperty(u) ? null : (i[u] = !0,
                    (0,
                        n.h)(a, u, {
                      validations: o,
                      prop: e,
      ...
      var P = function(t, e) {
        ...
        beforeCreate: function() {
          var t = this.$options;
          t.validations && (t.computed || (t.computed = {}),
          t.computed.$v || (t.computed.$v = function() {
