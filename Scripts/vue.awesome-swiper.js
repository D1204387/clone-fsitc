 ...
 */
!function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports, require("swiper"), require("vue")) : "function" == typeof define && define.amd ? define(["exports", "swiper", "vue"], t) : t((e = e || self).VueAwesomeSwiper = {}, e.Swiper, e.Vue)
}(this, function(e, t, n) {
  "use strict";
  var i;
  ...
  function s() {
    ...
    var i = Array(e)
        , o = 0;
    for (t = 0; t < n; t++)
      for (var r = arguments[t], l = 0, a = r.length; l < a; l++,
          o++)
        i[o] = r[l];
    return i
  }
  ...
  function f(e, t) {
    ...
    return {
      bind: function(e, t, n) {
        -1 === e.className.indexOf(l.containerClass) && (e.className += (e.className ? " " : "") + l.containerClass),
      ...
      inserted: function(t, n, i) {
        var r = i.context
            ...
            , p = r
            , v = null == p ? void 0 : p[s];
        v && !v.destroyed || (v = new e(t,l),
            p[s] = v,
            c(v, u),
            u(o.Ready, v))
      },
      componentUpdated: function(e, t, i) {
        var o, l, a, u, p, c, v, h, w, S, y, m, C = n(i, r.AutoUpdate);
        if (f(C)) {
          var g = s(e, t, i);
          if (g) {
            var I = d(t).loop;
            I && (null === (l = null === (o = g) || void 0 === o ? void 0 : o.loopDestroy) || void 0 === l || l.call(o)),
            null === (a = null == g ? void 0 : g.update) || void 0 === a || a.call(g),
            null === (p = null === (u = g.navigation) || void 0 === u ? void 0 : u.update) || void 0 === p || p.call(u),
            null === (v = null === (c = g.pagination) || void 0 === c ? void 0 : c.render) || void 0 === v || v.call(c),
            null === (w = null === (h = g.pagination) || void 0 === h ? void 0 : h.update) || void 0 === w || w.call(h),
            I && (null === (y = null === (S = g) || void 0 === S ? void 0 : S.loopCreate) || void 0 === y || y.call(S),
            null === (m = null == g ? void 0 : g.update) || void 0 === m || m.call(g))
          }
        }
      },
  ...
  function h(e) {
    ...
    return n.extend({
      ...
      data: function() {
        var e;
        return (e = {})[i.SwiperInstance] = null,
            e
      },
      computed: {
        swiperInstance: {
      ...
      methods: {
        ...
        autoReLoopSwiper: function() {
          ...
          if (this.swiperInstance && this.swiperOptions.loop) {
            ...
            null === (e = null == n ? void 0 : n.loopDestroy) || void 0 === e || e.call(n),
            null === (t = null == n ? void 0 : n.loopCreate) || void 0 === t || t.call(n)
          }
        },
        updateSwiper: function() {
          var e, t, n, i, o, l, a, s;
          this[r.AutoUpdate] && this.swiperInstance && (this.autoReLoopSwiper(),
          ...
          null === (l = null === (o = this.swiperInstance.pagination) || void 0 === o ? void 0 : o.render) || void 0 === l || l.call(o),
          null === (s = null === (a = this.swiperInstance.pagination) || void 0 === a ? void 0 : a.update) || void 0 === s || s.call(a))
        },
    ...
    var t = function(n, o) {
      if (!t.installed) {
        ...
        o && (r.options.props.defaultOptions.default = function() {
            ...
            n.component(i.SwiperComponent, r),
            n.component(i.SwiperSlideComponent, w),
            n.directive(i.SwiperDirective, f(e, o)),
            t.installed = !0
      }
    };
    return t
